...
public class RestItemController {
	...
	//127.0.0.1"8089/rest/itemsearch.json?txt=사과&key=abc
	@RequestMapping(value="/rest/itemsearch.json",
			method = {RequestMethod.GET, RequestMethod.POST},
			produces = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody HashMap<String, Object>itesmSearch(
	...
	//127.0.0.1"8089/rest/itemone.json?no=1&key=abc
	@RequestMapping(value="/rest/itemone.json",
			method = {RequestMethod.GET, RequestMethod.POST},
			produces = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody HashMap<String, Object>itesmOne(
